// This module exports functions that give access to the CSAPI API hosted at localhost:8080.
...
define(['axios'] , function (axios) {
  ...
  // path is the request path, the format is "/api/v1/health/:dc/:hgroup/:hostname"
